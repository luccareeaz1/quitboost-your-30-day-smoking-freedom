...
const FooterSection = () => {
  ...
  return (
    <footer className="py-20 border-t border-border bg-white dark:bg-black overflow-hidden relative">
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="pt-12 border-t border-border/50 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6 h-4 opacity-30 grayscale hover:grayscale-0 hover:opacity-100 transition-all">
             {/* Simple placeholders for security badges */}
             <div className="w-20 bg-muted rounded-md" />
             <div className="w-16 bg-muted rounded-md" />
          </div>
        </div>
      </div>
    </footer>
